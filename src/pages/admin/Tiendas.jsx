...
export default function Tiendas() {
  ...
  useEffect(() => {
    if (!admin?.id) {
      setError('Debes iniciar sesión como administrador para ver tus minimarkets.');
      return;
    }
    loadStores();
  }, [admin?.id]);
    ...
    <div className="container py-4">
      ...
      <div className="bg-white rounded-3 shadow-sm p-4 mb-4">
        <div className="d-flex justify-content-between align-items-center">
          <div>
            ...
            <p className="text-muted mb-0">Administra las tiendas asociadas a tu cuenta</p>
          </div>
          {loading && (
      ...
      {!admin?.id ? (
        <div className="alert alert-warning">
          Debes iniciar sesión como administrador para usar esta sección.
        </div>
      ) : (
        <div className="row">
              ...
              {loading && stores.length === 0 ? (
                ...
                <div className="list-group">
                  {stores.map((s) => (
                    <div
                      key={s.id}
                      className="list-group-item list-group-item-action d-flex justify-content-between align-items-center p-3 border-start border-4 border-primary border-opacity-25"
                    >
